...
negotiate({controller_delete_others, Item}, S=#state{otheritems=OtherItems}) ->
	notice(S, "Controller deleted other item ~p", [Item]),
    {next_state, negotiate, S#state{otheritems=remove(Item, OtherItems)}};

negotiate({controller_delete_own, Item}, S=#state{ownitems=OwnItems}) ->
	notice(S, "Controller deleted my item ~p", [Item]),
